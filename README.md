...
| ----------- | -------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| **Gateway** | `10443` (TCP)  | MTProto edge: abridged framing, DH handshake, RSA/AES криптография, TL-декодирование, маршрутизация RPC во внутренние gRPC-вызовы |
...
Gateway слушает на `localhost:10443` (MTProto TCP).
...
| `NTGRAM_GATEWAY_PORT`         | `10443`                                            | Порт Gateway           |
