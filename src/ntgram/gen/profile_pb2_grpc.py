...
class ProfileServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetProfile = channel.unary_unary(
                '/ntgram.profile.v1.ProfileService/GetProfile',
        ...
        self.UpdateProfile = channel.unary_unary(
                '/ntgram.profile.v1.ProfileService/UpdateProfile',
...
def add_ProfileServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ntgram.profile.v1.ProfileService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ntgram.profile.v1.ProfileService', rpc_method_handlers)
